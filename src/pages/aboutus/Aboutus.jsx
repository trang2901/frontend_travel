...
import demen from "../../image/dementour.jpg"
  ...
  <div className="container py-5">
    <div className="row h-100 align-items-center py-5">
      <div className="col-lg-6">
        ...
        <p className="font-italic">Dế Mèn tours là được thành lập nhằm đáp ứng nhu cầu du lịch của khách hàng là người Việt Nam. Với nhiều năm kinh nghiệm trong ngành du lịch, Dế Mèn tours chủ trương mang đến quí khách hàng các chương trình tour nghỉ dưỡng cao cấp, khám phá thiên nhiên, trải nghiệm cuộc sống và du lịch sinh thái khắp mọi nơi trên Tổ quốc.</p>
      </div>
      <div className="col-lg-6 d-none d-lg-block"><img src={demen} alt="" className="img-fluid" style={{borderRadius: '100%', height: '20em', width:'20em'}}/></div>
    </div>
  </div>
</div>
  ...
  <div className="container py-5">
    <div className="row align-items-center mb-5">
      <div className="col-lg-6 order-2 order-lg-1"><i className="fa fa-bar-chart fa-2x mb-3 text-primary"></i>
        ...
        <p className="font-italic">Là loại hình du lịch thời thượng phù hợp với những du khách có mong muốn trải nghiệm những dịch vụ đẳng cấp, sang trọng, khác biệt tại những khách sạn, resort đạt chuẩn quốc tế từ 4* trở lên.  Loại hình du lịch nghỉ dưỡng phù hợp với đa số du khách Việt: các cặp đôi muốn có những không gian lãng mạn và sang chảnh để ghi dấu tình yêu; các bạn trẻ muốn sống ảo; các gia đình muốn kết nối yêu thương các thế hệ; các du khách có tuổi muốn nghỉ ngơi thư giãn tận hưởng cuộc sống... Quí khách sẽ được hưởng thụ những dịch vụ 5* đẳng cấp quốc tế tại những resort sang chảnh đẳng cấp nhất.</p>
      </div>
...
Đây là hình thức kết hợp giữa du lịch và khám phá những điều 
mới mẻ không có trong cuộc sống thường ngày. Quí khách có cơ hội  được hòa mình vào cuộc sống thường nhật của 
những người dân địa phươngbản địa, được tham gia vào các hoạt động cụ thể như quá trình lao 
động sản xuất hay, cùng chuẩn bị những món ăn đặc sắc từng vùng miền. Điểm khác biệt của du lịch 
trải nghiệm là nó không đi theo lối mòn hay tiêu chuẩn cụ thể của những loại hình du lịch thông thường. 
Thay vì ngủ trong các khách sạn ở thành phố, quí khách có thể lựa chọn ngủ tại nhàđược mời ngủ lại nhà người dân 
để trực tiếp tham gia vào các hoạt động cồng đồng địa phương và từ đó sẽ có thêm những kinh nghiệm và kiến thức mới
hiểu rõ hơn cuộc sống cũng như bản sắc văn hóa địa phương. Với hình thức du lịch “mới mẻ” này, Quí khách sẽ có những 
trải nghiệm tuyệt vời và những kỉ niệm không thể nào quên.</p>
  ...
  <div className="container py-5">
    <div className="row mb-4">
      <div className="col-lg-5">
        <h2 className="display-4 font-weight-light">Dế Mèn team</h2>
        <p className="font-italic">Với đội ngũ này của chúng tôi, chúng tôi hi vọng sẽ mang đến cho quý khách hàng những dịch vụ tốt nhất</p>
      </div>
    </div>
