...
const Library2 = () => {
  ...
  return (
    <>
    <Container>
    <p style={{textAlign: 'center', color:'#08183c', fontWeight:'bold', fontSize: '2rem'}}>ẨM THỰC HÀ GIANG</p>
    <div style={{textAlign: 'center', justifyContent: 'center'}}>
        <ReactPlayer   
            ...
            width={1000}
            height={500}
            url="https://www.youtube.com/watch?v=a-2iTFdtnvk&feature=emb_title"
        ...
        <Row>
          ...
          <button>
          <img src={imgDN}/>
          <p>Du lịch đẹp Đà Nẵng</p></button></a>
          </Col>
