  ...
  {/* <div id="carousel-example-1z" class="carousel slide carousel-fade pt-4" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
      ...
      <div class="carousel-item active">
        <div class="view" 
        style={{
            background: `url("https://mdbootstrap.com/img/Photos/Horizontal/E-commerce/8-col/img%282%29.jpg")`,
      ...
      <div class="carousel-item">
        ...
        style={{
            background: `url("https://mdbootstrap.com/img/Photos/Horizontal/E-commerce/8-col/img%283%29.jpg")`,
            backgroundRepeat: 'no-repeat',
            backgroundSize: 'cover'
          }}
        >
      ...
      <div class="carousel-item">
        <div class="view" 
        style={{
            background: `url("https://mdbootstrap.com/img/Photos/Horizontal/E-commerce/8-col/img%285%29.jpg")`,
            backgroundRepeat: 'no-repeat',
            backgroundSize: 'cover'
          }}
        >
